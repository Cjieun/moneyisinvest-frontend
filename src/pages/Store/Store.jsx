      ...
      <div className="storeBox">
        <div className="storeContent">
          <div className="userCart">
            <div className="usercart-text">
              님이 담은 상품이에요 ({cart.length})
            </div>
            {cart.length > 0 && (
              <div className="cart-section">
                ...
                <button className="cartBuy-btn" onClick={onBuy}>
                  구매하기
                </button>
              </div>
            )}
                    ...
                    <tr key={product.id} className="product-item">
                      ...
                      <td className="td-btn">
                        <div onClick={() => addToCart(product)}>
                          <Button state="basket">장바구니</Button>
                        </div>
                        <div onClick={onBuy}>
                          <Button state="buy">구매하기</Button>
                        </div>
                      </td>
                    </tr>
                  ))}
